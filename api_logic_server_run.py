...
==============================================================================
    ...
    This file starts the API Logic Server (v 6.04.05, December 11, 2022 08:31:59):
...
app_logger.info(f'Created December 11, 2022 08:31:59 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 6.04.05\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 6.04.05\n'
    if is_docker():
